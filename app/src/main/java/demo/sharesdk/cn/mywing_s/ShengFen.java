...
public class ShengFen extends Activity {
...
//                tv_zone.setText("区");
                ...
                if (cityAdapter == null) {
                    cityAdapter = new MyAdapter<City>(ShengFen.this, cityList);
        ...
        lv_city.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (zoneAdapter == null) {
                    zoneAdapter = new MyAdapter<String>(ShengFen.this, zoneList);
                ...
                Intent i = new Intent();
                i.setAction("wahaha");
                i.putExtra("date", tv_pro.getText().toString());
                i.putExtra("sss", city.getCityName());
                Log.e("wahaha", "onItemClick: " + tv_pro.getText().toString() + "    " + city.getCityName());
                //startActivity(i);
                sendBroadcast(i);
                finish();
            }
